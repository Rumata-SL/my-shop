        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items">
                    <div className="cart__item">
                        <div className="cart__item-img"><img
                            ...
                            alt="Pizza"/></div>
                        <div className="cart__item-info"><h3>Маргарита</h3>
                            <p>тонкое, 26 см.</p></div>
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img"><img
                            ...
                            alt="Pizza"/></div>
                        <div className="cart__item-info"><h3>Четыре сезона</h3>
                            <p>тонкое, 26 см.</p></div>
                        <div className="cart__item-count">
                            <button disabled=""
                                    className="button button--outline button--circle cart__item-count-minus">
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img"><img
                            ...
                            alt="Pizza"/></div>
                        <div className="cart__item-info"><h3>Пепперони</h3>
                            <p>тонкое, 26 см.</p></div>
                        <div className="cart__item-count">
                            <button disabled=""
                                    className="button button--outline button--circle cart__item-count-minus">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details"><span> Всего пицц: <b>3 шт.</b> </span><span> Сумма заказа: <b>1520 ₽</b> </span>
                    </div>
